...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-card { background: #fff; padding: 30px; border-radius: 8px; max-width: 400px; margin: 80px auto; box-shadow: 0 2px 8px rgba(0,0,0,0.1); }
...
<body>
    <div class="login-card">
        ...
        <div class="links">
            <a href="{{ route('customer.register') }}">还没有账号？立即注册</a>
        </div>
    </div>
</body>
</html>
